    ...
    public partial class third : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    PhotoLikesId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    UserLikesId = table.Column<Guid>(type: "uniqueidentifier", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_PhotoUser", x => new { x.PhotoLikesId, x.UserLikesId });
                    table.ForeignKey(
                        name: "FK_PhotoUser_AspNetUsers_UserLikesId",
                        column: x => x.UserLikesId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.NoAction);
                    table.ForeignKey(
                        name: "FK_PhotoUser_Photos_PhotoLikesId",
                        column: x => x.PhotoLikesId,
                        principalTable: "Photos",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.NoAction);
                });
